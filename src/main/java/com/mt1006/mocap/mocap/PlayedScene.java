...
public class PlayedScene
{
	...
	public boolean start(CommandSource commandSource, String name, int id)
	{
		...
		{
			commandSource.sendFailure(new TranslationTextComponent("mocap.commands.playing.start.failed.load"));
			return false;
		}
	...
	private boolean startPlayingRecording(CommandSource commandSource, SceneData data)
	{
		...
		if (profile == null)
		{
			commandSource.sendFailure(new TranslationTextComponent("mocap.commands.playing.start.failed.profile"));
			return false;
		}
		...
		{
			commandSource.sendFailure(new TranslationTextComponent("mocap.commands.playing.start.failed.load_header"));
			return false;
		}
