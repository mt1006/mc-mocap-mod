...
public class CommandUtils
{
	...
	public static RequiredArgumentBuilder<CommandSource, String> withStringArgument(BiFunction<CommandSource, String, Boolean> function, String arg)
	{
		return Commands.argument(arg, StringArgumentType.string()).executes((ctx) -> stringCommand(function, ctx, arg));
	}

	public static RequiredArgumentBuilder<CommandSource, String> withTwoStringArguments(BlockStateVariantBuilder.ITriFunction<CommandSource, String, String, Boolean> function, String arg1, String arg2)
	{
	...
	private static int stringCommand(BiFunction<CommandSource, String, Boolean> function, CommandContext<CommandSource> ctx, String arg)
	{
		try
		{
	...
	private static int twoStringCommand(BlockStateVariantBuilder.ITriFunction<CommandSource, String, String, Boolean> function, CommandContext<CommandSource> ctx, String arg1, String arg2)
	{
		try
		{
